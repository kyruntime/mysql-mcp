...
간단한 설정, 바로 사용 가능, 빠르고 안전합니다. 자연어로 데이터베이스와 대화하세요.
...
- **mysql_use_database** — 현재 데이터베이스 전환 (`USE db_name`)
- **mysql_export_csv** — 테이블 데이터 또는 쿼리 결과를 CSV로 내보내기
